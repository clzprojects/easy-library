...
public class BookController implements Serializable {
    ...
    @EJB private com.developerbhuwan.easylibrary.ejbs.BookFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/bundle/LibrarianMessage").getString("BookCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/bundle/LibrarianMessage").getString("BookUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/bundle/LibrarianMessage").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/bundle/LibrarianMessage").getString("BookDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/bundle/LibrarianMessage").getString("PersistenceErrorOccured"));
        }
    }
